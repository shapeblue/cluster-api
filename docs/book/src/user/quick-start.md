...
A full configuration reference can be found in [configuration.md](https://github.com/shapeblue/cluster-api-provider-cloudstack/blob/master/docs/book/src/clustercloudstack/configuration.md).
